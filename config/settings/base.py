"""
Django Base Settings for ExportReady.AI
...
# Password Hashing - Use bcrypt as primary hasher
PASSWORD_HASHERS = [
...
SPECTACULAR_SETTINGS = {
    "TITLE": "ExportReady.AI API",
    "DESCRIPTION": "AI Platform for Indonesian UMKM Export - Backend API Services",
    "VERSION": "1.0.0",
